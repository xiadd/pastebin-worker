  ...
  return (
    <article
      ...
      className="prose prose-lg dark:prose-invert max-w-none
        ...
        prose-code:text-pink-600 dark:prose-code:text-pink-400 prose-code:bg-gray-100 dark:prose-code:bg-gray-800/60 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-medium
        prose-pre:bg-gray-100 dark:prose-pre:bg-gray-950 prose-pre:text-gray-800 dark:prose-pre:text-gray-300 prose-pre:border dark:prose-pre:border-gray-800
